...
struct Post
{
    ...
    static func fetchPosts() -> [Post]
    {
        ...
        let post7 = Post(createdBy: duc, timeAgo: "2d ago", caption: "Love it!", image: UIImage(named: "7"), numberOfLikes: 2, numberOfComments: 8, numberOfShares: 9)
        
        let brendon = Users(username: "Brendon Burchard", profileImage: UIImage(named: "brendon"))
